...
package.domain = org.example.practiceapp
...
# android.sdk = 31  # DEPRECATED - This setting is no longer used
...
# (defaults to True if android.logcat_filters is specified)
...
# (str) The value to be used for the PYTHONPATH environment variable
# p4a.pythonpath =

# (str) The value to be used for the ANDROIDAPI environment variable
# p4a.androidapi =

# (str) The value to be used for the NDKAPI environment variable
# p4a.ndkapi =

# (bool) If True, then fail if python-for-android is not found
# p4a.setup_py = false
